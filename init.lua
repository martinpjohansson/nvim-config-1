...
-- Set up a mapping for Command + S to save
...
-- Map <leader>E to open Oil in the current buffer's directory
  ...
  },
  {
    ...
    config = function()
      require('lualine').setup {
        options = { theme = 'ayu' },
        sections = {
          lualine_c = { '%2l:%-2v' }, -- Show LINE:COLUMN in the middle section
        },
      }
    end,
  },
